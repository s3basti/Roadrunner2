...
while True:
    try:
        ...
        theta = todeg(-m1pos + m1pos_offset) #(wheel angle)
        ...
        beta18 = bindto18(bindto360(pitch + theta + beta0))
        ...
        print('Theta: %.4f Pitch: %.3f Beta: %.4f Speed: %.4f Beta18: %.4f' % (theta,pitch,beta,m1speed,beta18))
